...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "REAL SACHIYA",
    ownernumber: process.env.Owner_Number || "94767361910",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://realsachiya00:ix41tIs2JM1VdEGU@cluster0.jvojn.mongodb.net/",
    sessionId: process.env.SESSION_ID || "GPELedFLN7CJiI_A_N_Y_A_V_2_Wh13SW",
